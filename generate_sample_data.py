...
Creates files for several dates so backfill and incremental loads can be demoed:
  - 2026-08-07: clean baseline
  - 2026-08-08: clean, with a few new customers + an updated product
  - 2026-08-09: deliberately contains broken rows (for quarantine demo)
  - 2026-08-10: schema drift (extra column — should warn, not fail)
"""
...
CLEAN_ORDERS = {
    "2026-08-07": [
        ("O00000001", "C001", "P001", "2026-08-07", "49.99",  "USD", "shipped",   "1"),
        ("O00000002", "C002", "P002", "2026-08-07", "129.50", "USD", "pending",   "2"),
        ("O00000003", "C003", "P001", "2026-08-07", "49.99",  "USD", "delivered", "1"),
        ("O00000004", "C001", "P003", "2026-08-07", "15.00",  "USD", "cancelled", "1"),
        ("O00000005", "C004", "P002", "2026-08-07", "129.50", "USD", "shipped",   "1"),
    ],
    "2026-08-08": [
        ("O00000006", "C002", "P004", "2026-08-08", "299.00", "USD", "shipped",   "1"),
        ("O00000007", "C005", "P001", "2026-08-08", "49.99",  "USD", "pending",   "1"),
        ("O00000008", "C003", "P005", "2026-08-08", "9.99",   "USD", "delivered", "3"),
        ("O00000009", "C001", "P002", "2026-08-08", "129.50", "USD", "shipped",   "1"),
    ],
    "2026-08-09": [
        # 4 good rows, 3 deliberately broken
        ("O00000010", "C002", "P001", "2026-08-09", "49.99",  "USD", "shipped",   "1"),
        ("O00000011", "C004", "P003", "2026-08-09", "15.00",  "USD", "pending",   "1"),
        ("O00000012", "C005", "P004", "2026-08-09", "299.00", "USD", "delivered", "2"),
        ("O00000013", "C003", "P002", "2026-08-09", "129.50", "USD", "shipped",   "1"),
        # BAD: negative amount
        ("O00000014", "C001", "P001", "2026-08-09", "-10.00", "USD", "shipped",   "1"),
        # BAD: unknown status
        ("O00000015", "C002", "P002", "2026-08-09", "129.50", "USD", "warped",    "1"),
        # BAD: quantity zero
        ("O00000016", "C003", "P003", "2026-08-09", "15.00",  "USD", "delivered", "0"),
    ],
    "2026-08-10": [
        # Schema drift: extra column "promotion_code" added by upstream
        ("O00000017", "C001", "P001", "2026-08-10", "49.99",  "USD", "shipped",   "1", "BLACKFRI"),
        ("O00000018", "C002", "P004", "2026-08-10", "299.00", "USD", "pending",   "1", "BLACKFRI"),
        ("O00000019", "C006", "P001", "2026-08-10", "49.99",  "USD", "shipped",   "1", ""),
    ],
}
...
CLEAN_CUSTOMERS = {
    ...
    "2026-08-09": [
        ...
        {"customer_id": "C007", "name": "Grace Bad", "email": "not-an-email",
         "signup_date": "2026-08-09", "address": {}, "phones": []},
        # BAD: missing required field "name"
        {"customer_id": "C008", "email": "henry@example.com", "signup_date": "2026-08-09",
         "address": {}, "phones": []},
    ],
    "2026-08-10": [
...
INITIAL_PRODUCTS = [
    ("P001", "Wireless Mouse",       "Electronics",  "49.99",  "2026-08-07T10:00:00"),
    ("P002", "Mechanical Keyboard",  "Electronics",  "129.50", "2026-08-07T10:00:00"),
    ("P003", "USB-C Cable 2m",       "Accessories",  "15.00",  "2026-08-07T10:00:00"),
    ("P004", "27\" Monitor",         "Electronics",  "299.00", "2026-08-07T10:00:00"),
    ("P005", "Notebook A5",          "Stationery",   "9.99",   "2026-08-07T10:00:00"),
]

PRODUCT_UPDATES = [
    # P001 price drop (SCD-1: overwrite)
    ("P001", "Wireless Mouse",       "Electronics",  "44.99",  "2026-08-08T08:00:00"),
    # New product
    ("P006", "Webcam HD",            "Electronics",  "79.00",  "2026-08-08T08:00:00"),
]
...
def generate_all(*, only_initial: bool = False) -> None:
    ...
    # Orders + customers
    dates_to_write = ["2026-08-07"] if only_initial else list(CLEAN_ORDERS.keys())
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--initial-only", action="store_true",
                        help="Only generate the 2026-08-07 baseline (for the first run demo)")
